...
(async () => {
    ...
    await (async () => {
        ...
        const renderTemplate = (svgStr) => `var dom = document.createElement('div');dom.setAttribute("aria-hidden", "true");dom.style.position = "absolute";dom.style.width = 0;dom.style.height = 0;dom.style.overflow = "hidden";dom.innerHTML = '${svgStr}';document.body.append(dom);`;
